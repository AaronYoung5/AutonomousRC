...
"""autogenerated by genpy from common_srvs/PathRequest.msg. Do not edit."""
import sys
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from common_srvs/PathResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class PathResponse(genpy.Message):
  ...
  _type = "common_srvs/PathResponse"
  _has_header = False #flag to mark the presence of a Header object
